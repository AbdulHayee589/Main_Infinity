...
export default function TermsAndConditionsPage() {
    return (
        ...
        conditions. Do not continue to use InfinityCustom if you do not agree to
        take all of the terms and conditions stated on this page. The following
        terminology applies to these Terms and Conditions, Privacy Statement and
        Disclaimer Notice and all Agreements: "Client", "You" and "Your" refers
        ...
        Client and ourselves.`}
            ...
            <p>
                ...
                to, prevailing law of bg. Any use of the above terminology or
            ...
            <br />
            <p>
                We employ the use of cookies. By accessing InfinityCustom, you
                agreed to use cookies in agreement with the InfinityCustom’s
            ...
            <br />
            <p>
                Unless otherwise stated, InfinityCustom and/or its licensors own
                the intellectual property rights for all material on
                InfinityCustom. All intellectual property rights are reserved.
                You may access this from InfinityCustom for your own personal
            ...
            <ul>
                ...
                <li>
                    2. Sell, rent or sub-license material from InfinityCustom
                </li>
                <li>
                    3. Reproduce, duplicate or copy material from InfinityCustom
                </li>
                <li>4. Redistribute content from InfinityCustom</li>
            </ul>
            ...
            <p>
                ...
                website. InfinityCustom does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of InfinityCustom ,its agents
                and/or affiliates. Comments reflect the views and opinions of
                the person who post their views and opinions. To the extent
                permitted by applicable laws, InfinityCustom shall not be liable
                ...
                InfinityCustom reserves the right to monitor all Comments and to
            ...
            <ul>
                ...
                <li>
                    2. The Comments do not invade any intellectual property
            ...
            <p>
                You hereby grant InfinityCustom a non-exclusive license to use,
            ...
            <ul>
                ...
                <li>
                    6. accounting, law and consulting firms and educational
            ...
            <p>
                ...
                of InfinityCustom ; and (d) the link is in the context of
            ...
            <p>
                ...
                by sending an e-mail to InfinityCustom . Please include your
            ...
            <ul>
                ...
                <li>
                    3. By use of any other description of our Website being
            ...
            <p>
                No use of InfinityCustom ’s logo or other artwork will be
